...
import sc.ejemploestudiante.controladores.ControladorPrincipal;
...
public class EjemploEstudiante {
    ...
    public static void main(String[] args) {
        ...
        iniciarDatosPrueba(estudiantes,bibliotecarios);
        
        java.awt.EventQueue.invokeLater(() ->{
        ControladorPrincipal controladorPrincipal = new ControladorPrincipal(bibliotecarios, estudiantes, libros);
        controladorPrincipal.mostrarLogin();
        });
        
    }
    
    public static void  iniciarDatosPrueba(RepositorioEstudiante estudiantes, RepositorioBibliotecario bibliotecarios){
        //Agregar Estudiante
