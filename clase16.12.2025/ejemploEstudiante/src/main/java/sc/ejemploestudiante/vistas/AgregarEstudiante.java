 ...
 * @author Moises Conde
 */
public class AgregarEstudiante extends java.awt.Dialog {
    private ControladorAdministrador controlador;
    /**
     * Creates new form AgregarEstudiante
     */
    public AgregarEstudiante(java.awt.Frame parent, boolean modal, ControladorAdministrador controlador) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nuevo Estudiante ");
    ...
    try {
        ...
        String carne = txtCarnet.getText().trim();
        ...
        // Agregarlo donde corresponda (ajusta el método real que tengas)
        controlador.agregarEstudiante(nuevo);

        // Cerrar dialog y listo
        setVisible(false);
        dispose();
